        ...
        },
        {
          ...
          getData.length >= 1 ? (
            <Popconfirm title="Sure to delete?" onConfirm={() => console.log("evet")}>
              <ButtonGroup>
        <Button size="small" type="primary" danger onClick={(event)=>{console.log(event)}}>Sil</Button><Button size="small" type="primary" onClick={(event)=>{console.log(event)}}>Update</Button>
      </ButtonGroup>
            </Popconfirm>
          ) : null,
        }
