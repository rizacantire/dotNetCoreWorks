...
export default  function AuthorList() {
    ...
    const getData = getList.map((message) => ({
      ...
      deleteItem:(<ButtonGroup>
        <Button size="small" type="primary" danger onClick={()=>{deleteItem(message.id)}}>Sil</Button><Button size="small" type="primary" onClick={()=>{updateItem(message.id)}}>Update</Button>
      </ButtonGroup>)
