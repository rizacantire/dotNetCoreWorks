...
export default function AuthorUpdate(props) {
  ...
  //  }
    console.log(author);
    console.log(props.updatedItem.birthDate);
    let da = new Date(props.updatedItem.birthDate)
    let birt = da.format('YYYY-MM-DD')
    console.log(birt);
  };
  ...
  return (
    ...
    >
      ...
      >
        <DatePicker defaultValue={moment(props.updatedItem.birthDate, dateFormat)}  format={dateFormat}/>
      </Form.Item>
