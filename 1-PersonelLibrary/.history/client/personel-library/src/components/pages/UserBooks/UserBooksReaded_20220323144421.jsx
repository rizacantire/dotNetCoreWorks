  ...
  const columns = [
    ...
    },
    {
      ...
      render: (result) =>
        ...
        (<Form.Item>
          <Button style={{marginLeft:"25%"}} type='primary' size='small' onClick={()=>setReadTime(result)}>Tarih Ekle</Button>
    ...
    },
    {
      ...
      record.finishReadDate&&(<Form.Item>
        <Button style={{marginLeft:"25%"}} type='primary' size='small' onClick={()=>setReadTime(record)}>Güncelle</Button>
        <DatePicker style={{marginTop:"0.2em"}} onChange={dateRead} />
      </Form.Item>)
      // <Button style={{backgroundColor:"green",color:"white"}}  size='small'
