  ...
  const columns = [
    ...
    },
    {
      ...
      render: (result) =>
        ...
        (<Form>
          <Form.Item>
          <Button style={{marginLeft:"2em"}} type='primary' size='small' onClick={()=>setReadTime(result)}>Tarih Ekle</Button>
          </Form.Item>
    ...
    },
    {
      title: "",
      render: (record) => 
      record.finishReadDate&&(
      <Form>
        <Form.Item>
        <Button style={{marginLeft:"2em%"}} type='primary' size='small' onClick={()=>setReadTime(record)}>Güncelle</Button>
        </Form.Item>
        <DatePicker  onChange={dateRead} />
      </Form>)
    },
