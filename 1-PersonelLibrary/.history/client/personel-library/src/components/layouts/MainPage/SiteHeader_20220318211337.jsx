    ...
    <div>
     ...
     backgroundSize: "cover",}}
        ...
        title={
          ...
          <Menu  style={{backgroundImage: `url(${background})`,backgroundRepeat: "no-repeat",width: "100%",height: "120px",
          backgroundSize: "cover",}} key="menu1" theme="light" mode="horizontal" defaultSelectedKeys={["1"]}>
