...
import buttonMenu from "../../../images/menu.jpg";
...
export default function SiteHeader() {
  ...
  return (
    <div>
      <PageHeader style={{backgroundImage: `url(${background})`,backgroundRepeat: "no-repeat",width: "100%",height: "120px",
     backgroundSize: "cover"}}
        ghost={false}
        onBack={() => window.history.back()}
        title={
          <Menu
          style={{backgroundColor:"#98a39b"}}
