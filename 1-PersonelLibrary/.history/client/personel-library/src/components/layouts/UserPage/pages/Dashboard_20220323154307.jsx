...
import UserPassUpdate from '../../../pages/Users/UserPassUpdate'
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path='/uyeler/:id' element={<UserBooksForAdminDetail/>} />
        <Route path='/uye-kontrol' element={<UserPassUpdate/>} />
