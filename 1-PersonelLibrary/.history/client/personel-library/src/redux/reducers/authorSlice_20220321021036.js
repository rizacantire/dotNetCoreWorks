...
export const getAuthorsByExcel = createAsyncThunk("api/getAuthorsByExcel",async()=>{
    const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/GetAuthorWithXml`,{headers:`Content-Type: multipart/form-data" -F "file=@yazar.xlsx;type=application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`})
    return await res.data
})
