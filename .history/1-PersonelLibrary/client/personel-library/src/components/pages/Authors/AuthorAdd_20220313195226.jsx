  ...
  return (
    <div style={{margin:"auto"}}>
      <Form name="basic" labelCol={{ span: 6 }} wrapperCol={{ span: 14 }} onFinish={handleSubmit }
        ...
        <Form.Item  label="Adı"  rules={[{required: true,message: "Lütfen Yazar Adını Girin!",},]} >
          <Input />
        </Form.Item>

        <Form.Item name={firstName}  label="Soyad" rules={[{required: true,message: "Lütfen Yazar'ın soyadını girin!",},]}>
          <Input/>
        </Form.Item>
